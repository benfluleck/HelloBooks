...
const JS_PRIMITIVES = ['null', 'undefined', 'boolean', 'number', 'string', 'date', 'regexp'];
...
function isBoolean (v) { return jsType(v) === 'boolean' }
function isString (v) { return jsType(v) === 'string' }
function isNumber (v) { return jsType(v) === 'number' }
function isArray (v) { return jsType(v) === 'array' }
function isObject (v) { return jsType(v) === 'object' }
function isObjectLike (v) { return v === Object(v) } // objects, arrays, functions, date, custom object
function isDate (v) { return jsType(v) === 'date' }
function isRegExp (v) { return jsType(v) === 'regexp' }
function isFunction (v) { return jsType(v) === 'function' }
function isNil (v) { return isNull(v) || isUndefined(v) }
function isNull (v) { return jsType(v) === 'null' }
function isUndefined (v) { return jsType(v) === 'undefined' }
 ...
 * @return {void}
 */
function each (obj, callback, ctx = null) {
 ...
 */
function map (obj, callback, ctx = null) {
  if (isArray(obj)) {
